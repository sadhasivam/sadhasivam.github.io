...
import { copyFile, mkdir, readdir, cp } from 'fs/promises';
...
async function build(): Promise<void> {
  ...
  try {
    ...
    try {
      ...
      console.log('ℹ️  No favicon.png found (skipping)\n');
    }
    ...
    await copyFile('generated/resume.md', 'docs/downloads/sadhasivam-jayabalaganesan-resume.md');
